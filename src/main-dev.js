...
export async function configure(aurelia) {
    aurelia.use
        ...
        .plugin("aurelia-api", config => {
            ...
            var auth = "https://com-ag-service-auth-dev.azurewebsites.net/v1/";
            var production = "https://dl-production-webapi-dev.azurewebsites.net/v1/";
            var productionAzure = "https://com-ag-service-finishing-printing-dev.azurewebsites.net/v1/";
            ...
            var customsReport = "https://com-ag-service-support-dev.azurewebsites.net/v1/";
            ...
            var garmentProduction = "https://com-ag-service-garment-dev.azurewebsites.net/";
            var packingInventory = "https://com-ag-service-packing-inventory-dev.azurewebsites.net/v1/";
