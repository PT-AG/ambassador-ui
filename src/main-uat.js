...
export async function configure(aurelia) {
    aurelia.use
        ...
        .plugin("aurelia-api", config => {
            ...
            var core = "https://com-ag-service-core-uat.azurewebsites.net/v1/";
            var auth = "https://com-ag-service-auth-uat.azurewebsites.net/v1/";
            var production = "https://dl-production-webapi-uat.azurewebsites.net/v1/";
            var productionAzure = "https://com-ag-service-finishing-printing-uat.azurewebsites.net/v1/";
            var purchasing = "https://dl-purchasing-webapi-uat.azurewebsites.net/v1/";
            var purchasingAzure = "https://com-ag-service-purchasing-uat.azurewebsites.net/v1/";
            ...
            var inventoryAzure = "https://com-ag-service-inventory-uat.azurewebsites.net/v1/";
            ...
            var spinning = "https://com-ag-service-spinning-uat.azurewebsites.net/";
            var intPurchasing = "https://com-ag-service-internal-transfer-uat.azurewebsites.net/v1/";
            var customsReport = "https://com-ag-service-support-uat.azurewebsites.net/v1/";
            var merchandiser = "https://com-ag-service-md-uat.azurewebsites.net/v1/";
            const dealTracking = 'https://com-ag-service-deal-tracking-uat.azurewebsites.net/v1/';
            const sales = "https://com-ag-service-sales-uat.azurewebsites.net/v1/";
            var weaving = "https://com-ag-service-weaving-uat.azurewebsites.net/";
            var finance = "https://com-ag-service-finance-accounting-uat.azurewebsites.net/v1/";
            var garmentProduction = "https://com-ag-service-garment-uat.azurewebsites.net/";
            var packingInventory = "https://com-ag-service-packing-inventory-uat.azurewebsites.net/v1/";
