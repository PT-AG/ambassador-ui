                  ...
                  for (var data of result) {
                       var SECTION = data.Section;
                        if (!dataBySection[SECTION]) dataBySection[SECTION] = [];                 
                            ...
                            CommisionIDR : data.CommisionIDR.toLocaleString('en-EN',{minimumFractionDigits: 2, maximumFractionDigits: 2}),
                            ...
                            HPP : data.HPP.toLocaleString('en-EN',{minimumFractionDigits: 4, maximumFractionDigits: 4}),                      
