...
export class ROItem {
        ...
        if (newValue) {
            ...
            if (newValue.Id) {
                ...
                if (this.data.Items.length == 0) {
                    this.data.Amount = parseFloat(this.data.Quantity * parseFloat(newValue.ConfirmPrice));
                }
            }
        } else {
            this.ROList.splice(this.ROList.indexOf(oldValue.RO_Number), 1);
    ...
    PriceChanged(e) {
        ...
        this.data.Amount = parseFloat(this.data.Quantity * parseFloat(e.srcElement.value));
    }
    ...
    async itemsChanged(e) {
        ...
        if (this.data.Items) {
            ...
            if (this.data.Items.length == 0) {
                ...
                this.data.Amount = parseFloat(this.data.Quantity * parseFloat(price.ConfirmPrice));
            }
        }
    }
    ...
    get removeItems() {
        return async (event) => 
        {
            ...
            if (this.data.Items.length == 0) {
                ...
                this.data.Amount = parseFloat(this.data.Quantity * parseFloat(this.data.Price));
