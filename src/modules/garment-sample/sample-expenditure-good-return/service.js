...
const serviceUri = 'sample-expenditure-good-returns';
const comodityPriceserviceUri = 'comodity-prices';
const expenditureGoodServiceUri = 'garment-sample-expenditure-goods';
...
export { Service,SalesService,PurchasingService, CoreService }