  ...
  searching() {
    ...
    this.service.search(info).then((result) => {
      ...
      for (var _data of result) {
        ...
        _data._QtyCuttingTransfer = _data.QtyCuttingTransfer.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        _data._PriceCuttingTransfer = _data.PriceCuttingTransfer.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._WipSewingOut = _data.WipSewingOut.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        _data._WipSewingOutPrice = _data.WipSewingOutPrice.toLocaleString(
          "en-EN",
          { minimumFractionDigits: 2, maximumFractionDigits: 2 }
        );
        ...
        _data._LocalQty = _data.LocalQty.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
        _data._LocalPrice = _data.LocalPrice.toLocaleString("en-EN", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        });
