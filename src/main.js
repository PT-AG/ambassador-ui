...
export async function configure(aurelia) {
    aurelia.use
        ...
        .plugin("aurelia-api", config => {
            ...
            var core = "https://com-ambassador-service-core-uat.azurewebsites.net/v1/";
            ...
            var productionAzure = "https://com-ambassador-service-finishing-printing-uat.azurewebsites.net/v1/";
            var purchasing = "https://dl-purchasing-webapi-uat.azurewebsites.net/v1/";
            var purchasingAzure = "https://com-ambassador-service-purchasing-uat.azurewebsites.net/v1/";
            ...
            var inventoryAzure = "https://com-ambassador-service-inventory-uat.azurewebsites.net/v1/";
            ...
            var spinning = "https://com-ambassador-service-spinning-uat.azurewebsites.net/";
            var intPurchasing = "https://com-ambassador-service-internal-transfer-uat.azurewebsites.net/v1/";
            var customsReport = "https://com-ambassador-service-support-uat.azurewebsites.net/v1/";
            var merchandiser = "https://com-ambassador-service-md-uat.azurewebsites.net/v1/";
            const dealTracking = 'https://com-ambassador-service-deal-tracking-uat.azurewebsites.net/v1/';
            const sales = "https://com-ambassador-service-sales-uat.azurewebsites.net/v1/";
            var weaving = "https://com-ambassador-service-weaving-uat.azurewebsites.net/";
            var finance = "https://com-ambassador-service-finance-accounting-uat.azurewebsites.net/v1/";
            var garmentProduction = "https://com-ambassador-service-garment-uat.azurewebsites.net/";
            var packingInventory = "https://com-ambassador-service-packing-inventory-uat.azurewebsites.net/v1/";
